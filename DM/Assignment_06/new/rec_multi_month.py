...
def process_train_data(train_file, list_dates, one_hot_mapping, renta_mapping_dict):
    ...
    for row in csv.DictReader(train_file):
        ...
        if date in pprev_dates:
            pprev_products_dict[usr] = gene_products(row)
...
def xgb_model(train_X, train_y, seed_val=0):
    param = {'objective': 'multi:softprob', 'eta': 0.036, 'max_depth': 8, 'silent': 1, 'num_class': 22,
...
def rec(train_file, test_file, res_file, list_dates=[['2015-04-28', '2016-04-28'], ['2015-05-28', '2016-05-28'], ['2015-06-28', '2016-06-28']]):
    ...
    train_list, train_label, prev_products_dict, pprev_products_dict = process_train_data(train_file, list_dates, one_hot_mapping_dict, renta_mapping_dict)
    test_list = process_test_data(test_file, prev_products_dict, pprev_products_dict, one_hot_mapping_dict, renta_mapping_dict)
...
if __name__ == '__main__':
    ...
    res_file = 'rec_multi_month_45-6_res7_round80.csv'
    t = datetime.datetime.now()
