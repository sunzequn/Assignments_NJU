...
def adaboost(data_mat, data_labels, data_flag, iteration_n, cross_n):
    ...
    for i in range(iteration_n):
        ...
        pred_labels = pred(inner_train_mat, inner_train_labels, inner_train_mat, data_flag, train_mat, train_labels)
        # train_w, e, alpha = update_w(train_w, train_labels, pred_labels)
        train_w, e, alpha = update_w(train_w, inner_train_indexes, inner_train_labels, pred_labels)
