...
def xgb_model(train_X, train_y, seed_val=0):
    param = {'objective': 'multi:softprob', 'eta': 0.04, 'max_depth': 10, 'silent': 1, 'num_class': 22,
             'eval_metric': "mlogloss", 'min_child_weight': 1, 'subsample': 0.85, 'colsample_bytree': 0.85,
             'seed': seed_val}
    num_rounds = 120
...
if __name__ == '__main__':
    ...
    res_file = 'prediction_on_test.csv'
    t = datetime.datetime.now()
